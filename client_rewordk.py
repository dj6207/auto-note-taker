...
def send_msg(msg, cmd_clientsocket):
...
def start():
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as CMD_CLIENTSOCKET:
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as AUD_CLIENTSOCKET:
